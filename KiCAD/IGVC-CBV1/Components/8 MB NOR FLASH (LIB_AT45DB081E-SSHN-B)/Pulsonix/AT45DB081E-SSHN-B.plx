...
(library Library_1
	...
	(patternDef "SOIC127P600X175-8N" (originalName "SOIC127P600X175-8N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.95 2.462) (pt 1.95 2.462) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.95 2.462) (pt 1.95 -2.462) (width 0.025))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.95 1.192) (pt -0.68 2.462) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "AT45DB081E-SSHN-B" (originalName "AT45DB081E-SSHN-B") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "SI") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "SCK") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "__RESET") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "__CS") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "SO") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "GND") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VCC") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "__WP") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.renesas.com/us/en/products/memory-logic/non-volatile-memory/spi-nor-flash/dataflash-spi-memory/at45db081e-8mbit-17-v-36-v-range-spi-serial-flash-memory")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "AT45DB081E-SSHN-B.stp")
