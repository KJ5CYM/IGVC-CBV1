...
//2086800/1127645/2.50/2/3/Capacitor
...
(library Library_1
	...
	(symbolDef "C0402C120F5GAC7867" (originalName "C0402C120F5GAC7867")
	...
	(compDef "C0402C120F5GAC7867" (originalName "C0402C120F5GAC7867") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "C0402C120F5GAC7867"))
		...
		(attr "Mouser Part Number" "80-C0402C120F5G7867")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/KEMET/C0402C120F5GAC7867?qs=jI8Gez59nxLF54Q0TqFmOw%3D%3D")
		(attr "Manufacturer_Name" "KEMET")
		(attr "Manufacturer_Part_Number" "C0402C120F5GAC7867")
		(attr "Description" "Multilayer Ceramic Capacitors MLCC - SMD/SMT 50V 12pF C0G 0402 1%")
		(attr "<Hyperlink>" "https://ms.componentsearchengine.com/Datasheets/1/C0402C120F5GAC7867.pdf")
		(attr "<Component Height>" "0.55")
		(attr "<STEP Filename>" "C0402C120F5GAC7867.stp")
		(attr "<STEP Offsets>" "X=-0.52;Y=-0.28;Z=0")
